...
function session(context) {
    return new Promise((resolve) => {
        const waitForCdApi = () => {
            if (typeof cdApi !== 'undefined' && typeof cdApi.changeContext === 'function' && cdApi.customerId == null) {
...
async function triggerAPI(action, activityType) {
    const payload = {
        "customerId": "dummy",
        "action": action,
        "customerSessionId": "286a14d0-6ddd-4d9b-8586-ddc5e4156d21", // Must match the one in session
